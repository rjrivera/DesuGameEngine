...
namespace RDash
{
    class rightHint : VFX
    {
        ...
        */
        ...
        public rightHint(Texture2D loadedTexture)//i shouldn't use this constructor...
        {
            rotation = 0.0f;
        ...
        public rightHint(float initX, float initY, float initRotation, float initXCenter, float initYCenter,
