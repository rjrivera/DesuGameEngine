...
namespace RDash
{
    public class TronDartGunSheet : Enemy
    {
        ...
        public float bulletTimer = 0f; //to be used as countdown for spacing multiple rounds. 
        public float bulletInterval = 0f;
       ...
       * parameters: None
       * */
        public TronDartGunSheet(float initX, float initY, float initRotation, float initFireTimer,
