...
namespace RDash
{
    class ring : VFX
    {
        ...
        */
        ...
        public ring(Texture2D loadedTexture)//i shouldn't use this constructor...
        {
            rotation = 0.0f;
        ...
        public ring(float initX, float initY, float initRotation, float initXCenter, float initYCenter,
        ...
        public override void Update(float gameTime, float backgroundX, float backgroundY)
        {
            ...
            this.position.X = backgroundX + velocity.X;//when not being used solo, this velocity will be set to zero...see unDeadCore.cSharp
            this.position.Y = backgroundY + velocity.Y;
