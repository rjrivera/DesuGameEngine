...
namespace RDash
{
    class DoorSmall : Door
    {
      ...
      * */
        public DoorSmall(float XDefault, float YDefault)
        {
            position.X = XDefault;
            position.Y = YDefault;
            Length = 360f;
       ...
       * */
        public DoorSmall(float XDefault, float YDefault, float initLength, Texture2D SkinDefault)
        {
            position.X = XDefault;
            position.Y = YDefault;
            Length = initLength;
        ...
        public bool setLock(bool currentLock)
        {
            unlock = currentLock;
