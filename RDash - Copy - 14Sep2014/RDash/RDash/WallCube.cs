...
namespace RDash
{
    class WallCube : Platform
    {
      ...
      * */
        public WallCube(float XDefault, float YDefault)
        {
            position.X = XDefault;
            position.Y = YDefault;
            Length = 360f;
       ...
       * */
        public WallCube(float XDefault, float YDefault, float initLength, Texture2D SkinDefault)
        {
            position.X = XDefault;
            position.Y = YDefault;
            Length = initLength;
