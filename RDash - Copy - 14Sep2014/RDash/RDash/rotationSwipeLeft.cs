...
namespace RDash
{
    class rotationSwipeLeft : VFX
    {
        ...
        */
        ...
        public rotationSwipeLeft(Texture2D loadedTexture)//i shouldn't use this constructor...
        {
            rotation = 0.0f;
        ...
        public rotationSwipeLeft(float initX, float initY, float initRotation, float initXCenter, float initYCenter,
