...
namespace RDash
{
    class health_Gauge_Holder : VFX
    {
        ...
        */
        ...
        public health_Gauge_Holder(Texture2D loadedTexture)//i shouldn't use this constructor...
        {
            rotation = 0.0f;
        ...
        public health_Gauge_Holder(float initX, float initY, float initRotation, float initXCenter, float initYCenter,
        ...
        public override void Update(float gameTime, float backgroundX, float backgroundY)
        {
            ...
            this.position.Y = backgroundY + 360f;
