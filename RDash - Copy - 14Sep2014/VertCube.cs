...
namespace RDash
{
    class VertCube : Platform
    {
      ...
      * */
        public VertCube(float XDefault, float YDefault)
        {
            position.X = XDefault;
            position.Y = YDefault;
            Length = 360f;
       ...
       * */
        public VertCube(float XDefault, float YDefault, float initLength, Texture2D SkinDefault)
        {
            position.X = XDefault;
            position.Y = YDefault;
            Length = initLength;
