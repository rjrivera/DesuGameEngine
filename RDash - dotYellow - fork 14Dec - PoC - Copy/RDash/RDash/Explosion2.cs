...
namespace RDash
{
    class Explosion2 : VFX
    {
        ...
        */
        ...
        public Explosion2(Texture2D loadedTexture)//i shouldn't use this constructor...
        {
            rotation = 0.0f;
        ...
        public Explosion2(float initX, float initY, float initRotation, float initXCenter, float initYCenter,
