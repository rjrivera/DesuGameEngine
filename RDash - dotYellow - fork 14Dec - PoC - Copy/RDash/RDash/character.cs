...
namespace RDash
{
    public class Character : Player
    {
        ...
        public float rotation, fireTimer, spriteTimer, spriteInterval, energy, energyCapacity, health, healthCapacity, maxSpeed, progressionTimer,
            allRangeX, allRangeY, respawnTimer, respawnInterval;//rotion done in radians if i remember.
        ...
        public bool alive, fire, airborne, levitation, hit, shield, spawnShieldRDash, spawnFlyingNimbus, fireCannonBall, allRangeMode, respawn;
