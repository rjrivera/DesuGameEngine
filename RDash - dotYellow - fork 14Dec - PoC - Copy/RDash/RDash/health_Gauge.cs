...
namespace RDash
{
    class health_Gauge : VFX
    {
        ...
        */
        ...
        public health_Gauge(Texture2D loadedTexture)//i shouldn't use this constructor...
        {
            rotation = 0.0f;
        ...
        public health_Gauge(float initX, float initY, float initRotation, float initXCenter, float initYCenter,
        ...
        //fed to this method. 
        public override void Update(float gameTime, float backgroundX, float backgroundY, float health, float healthCapacity)//need's a unique update since it changes size based on amount of Duke energy. 
        {
            ...
            spriteWidth = (int)(188 * (health / healthCapacity));//this provides the scaling to energy levels for the power bar. 
            this.position.X = backgroundX + 102f;//+2 offset from energygaugeholder. 
            this.position.Y = backgroundY + 364f;//+4 offset from energygaugeholder. 
