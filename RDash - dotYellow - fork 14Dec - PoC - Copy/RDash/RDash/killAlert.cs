...
namespace RDash
{
    class killAlert : VFX
    {
        ...
        */
        ...
        public killAlert(Texture2D loadedTexture)//i shouldn't use this constructor...
        {
            rotation = 0.0f;
        ...
        public killAlert(float initX, float initY, float initRotation, float initXCenter, float initYCenter,
            float initXVelocity, float initYVelocity, float backgroundX, float backgroundY, int sprites)
        {
            ...
            spriteWidth = 93; //hardcoded to enforce class uniqueness in design
            spriteHeight = 12;
