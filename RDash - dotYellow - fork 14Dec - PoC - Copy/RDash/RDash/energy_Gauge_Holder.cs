...
namespace RDash
{
    class energy_Gauge_Holder : VFX
    {
        ...
        */
        ...
        public energy_Gauge_Holder(Texture2D loadedTexture)//i shouldn't use this constructor...
        {
            rotation = 0.0f;
        ...
        public energy_Gauge_Holder(float initX, float initY, float initRotation, float initXCenter, float initYCenter,
            float initXVelocity, float initYVelocity, float backgroundX, float backgroundY, int sprites)
        {
            ...
            spriteWidth = 203; //hardcoded to enforce class uniqueness in design
            spriteHeight = 25;
        ...
        public override void Update(float gameTime, float backgroundX, float backgroundY)
        {
            ...
            this.position.X = backgroundX + 100f ;
            this.position.Y = backgroundY + 400f ; 
