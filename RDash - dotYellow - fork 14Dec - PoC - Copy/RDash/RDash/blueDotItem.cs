...
namespace RDash
{
    class blueDotItem : VFX
    {
        ...
        */
        ...
        public blueDotItem(Texture2D loadedTexture)//i shouldn't use this constructor...
        {
            rotation = 0.0f;
        ...
        public blueDotItem(float initX, float initY, float initRotation, float initXCenter, float initYCenter,
        ...
        public override Character consumeItem(Character charArg)
        {
            Character tempCharacter = charArg;
            tempCharacter.increaseHealth(10f);
            ttl = 0; //destroys item by 'committing suicide'
