...
namespace RDash
{
    class Explosion1 : VFX
    {
        ...
        */
        ...
        public Explosion1(Texture2D loadedTexture)//i shouldn't use this constructor...
        {
            rotation = 0.0f;
        ...
        public Explosion1(float initX, float initY, float initRotation, float initXCenter, float initYCenter,
