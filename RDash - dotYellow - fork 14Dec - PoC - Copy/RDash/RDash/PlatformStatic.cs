    ...
    class PlatformStatic : Platform
    {
      ...
      * */
        public PlatformStatic(float XDefault, float YDefault, float initLength, Texture2D SkinDefault)
        {
            ...
            Length = initLength;
            Skin = SkinDefault;
            this.SourceRect = new Rectangle((int)XDefault, (int)YDefault, (int)this.Skin.Width, (int)this.Skin.Height); //sets up source for stretching source sprite.
            visible = true;
            this.DestinationRect = new Rectangle((int) XDefault, (int) YDefault, (int)this.Length, (int)this.Skin.Height); //stretches source sprite. 
