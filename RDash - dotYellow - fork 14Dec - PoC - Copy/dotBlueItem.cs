...
namespace RDash
{
    class blueDotItem : VFX
    {
        ...
        */
        ...
        public redDotItem(Texture2D loadedTexture)//i shouldn't use this constructor...
        {
            rotation = 0.0f;
        ...
        public redDotItem(float initX, float initY, float initRotation, float initXCenter, float initYCenter,
        ...
        public override Character consumeItem(Character charArg)
        {
            ...
            tempCharacter.increaseEnergy(10f);
