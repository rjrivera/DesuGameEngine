...
namespace RDash
{
    public class VFX : GameObject
    {
        ...
        */
        ...
        public float spawnBackgroundX;
        public float spawnBackgroundY;
        ...
        public VFX(Texture2D loadedTexture)//i shouldn't use this constructor...
        {
            rotation = 0.0f;
